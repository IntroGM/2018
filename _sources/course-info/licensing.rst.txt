...
Thus, we share all the lesson materials openly, and also our source codes and lesson materials are openly available `from GitHub <https://github.com/IntroGM/2018>`_.
...
See the `full licence <https://creativecommons.org/licenses/by-sa/4.0/legalcode>`_.
...
Except where otherwise noted, the example programs, code snippets and other software provided by the Introduction to Geodynamic Modelling course are made available under the **GNU GPLv3 license** (read licence `here <https://www.gnu.org/licenses/gpl.html>`_.